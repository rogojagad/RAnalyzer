...
public class GUI extends javax.swing.JFrame {
    ...
    private void addDocumentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDocumentBtnActionPerformed
        int returnVal = this.documentOpener.showOpenDialog(this);
        
        if(returnVal == JFileChooser.APPROVE_OPTION){
            File file = documentOpener.getSelectedFile();
            String content = "";
            try {
            ...
            this.loadingDialog.setEnabled(true);
            ...
            this.project.addDocument(newDoc);
    ...
    public void dismissLoadingDialog(){
        this.loadingDialog.setEnabled(false);
